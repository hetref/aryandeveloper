        ...
        <div id="footer_grid">
          ...
          <div id="footer_projects">
            ...
            <div id="footer_projects_links">
              <div className="link">
                <a
                  href="https://devoutlook.netlify.app"
                  target="_blank"
              ...
              <div className="link">
                <a
                  href="https://hetref.github.io/csfurniture"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  Classic Furniture
              ...
              <div className="link">
                <a
                  href="https://hetref.github.io/yourtodo"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  Todo
              ...
              <div className="link">
                <a
                  href="https://hetref.github.io/codinguides"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  Coding Guidez
              ...
              <div className="link">
                <a
                  href="https://hetref.github.io/weatherapp"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  Weather Forecaster
              ...
              <div className="link">
                <a
                  href="https://hetref.github.io/textutils"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  Textutils
              ...
              <div className="link">
                <a
                  href="https://hetref.github.io/airline"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  Airlines
              ...
              <div className="link">
                <a
                  href="https://hetref.github.io/calc.github.io"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  Calculator
              ...
              <div className="link">
                <a
                  href="https://hetref.github.io/clocky"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  Clock
              ...
              <div className="link">
                <a
                  href="https://hetref.github.io/sourcecode"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  Souce Code
              ...
              <div className="link">
                <a
                  href="https://hetref.github.io/stopwatch"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  Stop Watch
              ...
              <div className="link">
                <a
                  href="https://hetref.github.io/tilesgame"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  Tile Game
